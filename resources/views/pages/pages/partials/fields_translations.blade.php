@php
    ...
    $slugOverwrite ??= config('gingerminds-cms.slug_overwrite.' . (isset($page) ? 'edit' : 'create'));
@endphp
...
<div class="col-lg-12">
    <div class="card">
        ...
        : []"
                ...
                :extra="['categoryPaths' => $categoryPaths, 'page' => $page ?? null, 'slugOverwrite' => $slugOverwrite]"
            />
        </div>
    </div>
</div>

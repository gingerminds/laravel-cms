...
@section('title')
    @lang('gingerminds-core::translation.title_m_create', ['model' => __('gingerminds-cms::translation.page_categories.name_s')])
@endsection

@section('breadcrumb')
    <x-gingerminds-core::navigation.breadcrumb
        :title="__('gingerminds-core::translation.title_m_create', ['model' => __('gingerminds-cms::translation.page_categories.name_s')])"
        :items="[
            ['label' => __('gingerminds-cms::translation.page_categories.name_p'), 'url' => route('gingerminds-cms.page-categories.index')],
            ['label' => __('gingerminds-core::translation.title_m_create', ['model' => __('gingerminds-cms::translation.page_categories.name_s')]), 'active' => true],
        ]"
    />
@endsection

@php
    $action = route('gingerminds-cms.page-categories.store');
    $indexRoute = route('gingerminds-cms.page-categories.index');
    $method = 'POST';
    $id = 'create-page_category-form';
    $title = __('gingerminds-core::translation.title_m_create', ['model' => __('gingerminds-cms::translation.page_categories.name_s')]);
@endphp

...
Route::middleware(['web', 'gingerminds-core.auth'])
    ...
    ->group(function () {
        ...
        Route::get(
            'pages/blocks/{key}/form',
            [ResourceResolver::controller('page_block'), 'form']
        )->name('pages.blocks.form');

        Route::post(
            'pages/blocks/{key}/validate',
            [ResourceResolver::controller('page_block'), 'validateBlock']
        )->name('pages.blocks.validate');
